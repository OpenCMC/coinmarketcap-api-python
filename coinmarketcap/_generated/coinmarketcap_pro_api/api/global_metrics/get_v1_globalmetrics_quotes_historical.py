...
from ...models.get_v1_globalmetrics_quotes_historical_interval import (
    GetV1GlobalmetricsQuotesHistoricalInterval,
)
from ...models.global_metrics_quotes_historic_response_model import GlobalMetricsQuotesHistoricResponseModel
...
def _get_kwargs(
    *,
    ...
    interval: GetV1GlobalmetricsQuotesHistoricalInterval | Unset = "1d",
    convert: str | Unset = UNSET,
    convert_id: str | Unset = UNSET,
    aux: str
    | Unset = "btc_dominance,eth_dominance,active_cryptocurrencies,active_exchanges,active_market_pairs,total_volume_24h,total_volume_24h_reported,altcoin_market_cap,altcoin_volume_24h,altcoin_volume_24h_reported",
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GlobalMetricsQuotesHistoricResponseModel.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    r"""Quotes Historical
     ...
     Returns an interval of historical global cryptocurrency market metrics based on time and interval
    parameters.
    ...
    **CMC equivalent pages:** Our Total Market Capitalization global chart
    ...
    Args:
        ...
        interval (GetV1GlobalmetricsQuotesHistoricalInterval | Unset):  Default: '1d'.
        convert (str | Unset):
        convert_id (str | Unset):
        aux (str | Unset):  Default: 'btc_dominance,eth_dominance,active_cryptocurrencies,active_e
            xchanges,active_market_pairs,total_volume_24h,total_volume_24h_reported,altcoin_market_cap
    ...
    Returns:
        Response[GlobalMetricsQuotesHistoricResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **CMC equivalent pages:** Our Total Market Capitalization global chart
    ...
    Returns:
        GlobalMetricsQuotesHistoricResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
