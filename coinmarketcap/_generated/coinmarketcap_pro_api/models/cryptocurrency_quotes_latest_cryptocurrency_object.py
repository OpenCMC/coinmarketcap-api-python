...
if TYPE_CHECKING:
    from ..models.cryptocurrency_quotes_latest_quote_map import CryptocurrencyQuotesLatestQuoteMap
    from ..models.platform_type_0 import PlatformType0


T = TypeVar("T", bound="CryptocurrencyQuotesLatestCryptocurrencyObject")


@_attrs_define
class CryptocurrencyQuotesLatestCryptocurrencyObject:
    ...
    Attributes:
        ...
        quote (CryptocurrencyQuotesLatestQuoteMap): A map of market quotes in different currency conversions. The
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quote = CryptocurrencyQuotesLatestQuoteMap.from_dict(d.pop("quote"))
        ...
        cryptocurrency_quotes_latest_cryptocurrency_object = cls(
            id=id,
            name=name,
            symbol=symbol,
            slug=slug,
        ...
        cryptocurrency_quotes_latest_cryptocurrency_object.additional_properties = d
        return cryptocurrency_quotes_latest_cryptocurrency_object
