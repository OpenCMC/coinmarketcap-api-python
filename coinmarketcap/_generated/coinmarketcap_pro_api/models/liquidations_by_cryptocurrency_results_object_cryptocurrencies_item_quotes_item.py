...
T = TypeVar("T", bound="LiquidationsByCryptocurrencyResultsObjectCryptocurrenciesItemQuotesItem")


@_attrs_define
class LiquidationsByCryptocurrencyResultsObjectCryptocurrenciesItemQuotesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        liquidations_by_cryptocurrency_results_object_cryptocurrencies_item_quotes_item = cls(
            crypto_id=crypto_id,
            symbol=symbol,
        ...
        liquidations_by_cryptocurrency_results_object_cryptocurrencies_item_quotes_item.additional_properties = d
        return liquidations_by_cryptocurrency_results_object_cryptocurrencies_item_quotes_item
