...
T = TypeVar("T", bound="DerivativesCryptoMarketPairsListLatestResultsObjectMarketPairsItemQuotesItem")


@_attrs_define
class DerivativesCryptoMarketPairsListLatestResultsObjectMarketPairsItemQuotesItem:
    """
    Attributes:
        ...
        price (float | Unset): Normalized last price in the conversion currency. Example: 80470.69372308.
        volume_24h (float | Unset): Normalized 24h trade volume in the conversion currency. Example: 55231696622.35106.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        derivatives_crypto_market_pairs_list_latest_results_object_market_pairs_item_quotes_item = cls(
            crypto_id=crypto_id,
            symbol=symbol,
            price=price,
        ...
        derivatives_crypto_market_pairs_list_latest_results_object_market_pairs_item_quotes_item.additional_properties = d
        return derivatives_crypto_market_pairs_list_latest_results_object_market_pairs_item_quotes_item
