...
from ...models.airdrops_response_model import AirdropsResponseModel
from ...models.get_v1_cryptocurrency_airdrops_status import (
...
def _get_kwargs(
    *,
    start: int | Unset = 1,
    limit: int | Unset = 100,
    status: GetV1CryptocurrencyAirdropsStatus | Unset = "ONGOING",
    id: str | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AirdropsResponseModel.from_dict(response.json())
...
def sync_detailed(
    ...
    **CMC equivalent pages:** Our free airdrops page
    ...
    Args:
        ...
        status (GetV1CryptocurrencyAirdropsStatus | Unset):  Default: 'ONGOING'.
        id (str | Unset):
        slug (str | Unset):
        symbol (str | Unset):
    ...
    Returns:
        Response[AirdropsResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **CMC equivalent pages:** Our free airdrops page
    ...
    Returns:
        AirdropsResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
