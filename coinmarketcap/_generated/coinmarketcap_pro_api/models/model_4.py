...
class Model4:
    ...
    currencies: list[Model3] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.currencies, Unset):
            currencies = []
            for componentsschemascurrencies_item_data in self.currencies:
                componentsschemascurrencies_item = componentsschemascurrencies_item_data.to_dict()
                currencies.append(componentsschemascurrencies_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _currencies is not UNSET:
            currencies = []
            for componentsschemascurrencies_item_data in _currencies:
                componentsschemascurrencies_item = Model3.from_dict(componentsschemascurrencies_item_data)
        ...
        model_4.additional_properties = d
        return model_4
