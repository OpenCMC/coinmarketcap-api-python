...
from ..models.cryptocurrency_market_pairs_latest_pair_base_currency_info_object_1_currency_type import (
    CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1CurrencyType,
    check_cryptocurrency_market_pairs_latest_pair_base_currency_info_object_1_currency_type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1")


@_attrs_define
class CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1:
    ...
    Attributes:
        ...
        currency_type (CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1CurrencyType): The currency type for
            the quote (secondary) currency in this market pair. Example: fiat.
    ...
    currency_symbol: str
    exchange_symbol: str
    currency_type: CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1CurrencyType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        currency_type = check_cryptocurrency_market_pairs_latest_pair_base_currency_info_object_1_currency_type(
            d.pop("currency_type")
        )
        ...
        cryptocurrency_market_pairs_latest_pair_base_currency_info_object_1 = cls(
            currency_id=currency_id,
            currency_symbol=currency_symbol,
            exchange_symbol=exchange_symbol,
            currency_type=currency_type,
        ...
        cryptocurrency_market_pairs_latest_pair_base_currency_info_object_1.additional_properties = d
        return cryptocurrency_market_pairs_latest_pair_base_currency_info_object_1
