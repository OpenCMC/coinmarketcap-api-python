...
from ...models.content_latest_posts_response_model import ContentLatestPostsResponseModel
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ContentLatestPostsResponseModel.from_dict(response.json())
...
def sync_detailed(
    ...
    **Plan credit use:** 0 credit
    ...
    Returns:
        Response[ContentLatestPostsResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **Plan credit use:** 0 credit
    ...
    Returns:
        ContentLatestPostsResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
