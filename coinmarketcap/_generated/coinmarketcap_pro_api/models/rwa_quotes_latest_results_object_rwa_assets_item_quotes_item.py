...
T = TypeVar("T", bound="RWAQuotesLatestResultsObjectRwaAssetsItemQuotesItem")


@_attrs_define
class RWAQuotesLatestResultsObjectRwaAssetsItemQuotesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rwa_quotes_latest_results_object_rwa_assets_item_quotes_item = cls(
            crypto_id=crypto_id,
            symbol=symbol,
        ...
        rwa_quotes_latest_results_object_rwa_assets_item_quotes_item.additional_properties = d
        return rwa_quotes_latest_results_object_rwa_assets_item_quotes_item
