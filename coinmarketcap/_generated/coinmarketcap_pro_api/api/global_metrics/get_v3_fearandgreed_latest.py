...
from ...models.fear_and_greed_latest_response_model import FearAndGreedLatestResponseModel
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FearAndGreedLatestResponseModel.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    r"""CMC Crypto Fear and Greed Latest
    ...
    api/v3/fear-and-greed/latest`. See the [Keyless Public
    ...
    **CMC equivalent pages:** Our CMC Crypto Fear and Greed Index card on
    ...
    Returns:
        Response[FearAndGreedLatestResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **CMC equivalent pages:** Our CMC Crypto Fear and Greed Index card on
    ...
    Returns:
        FearAndGreedLatestResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
