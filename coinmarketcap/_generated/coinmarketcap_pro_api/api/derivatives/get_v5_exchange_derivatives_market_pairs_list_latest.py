...
from ...models.derivatives_market_pairs_list_latest_response_model import DerivativesMarketPairsListLatestResponseModel
from ...models.get_v5_exchange_derivatives_market_pairs_list_latest_category import (
    GetV5ExchangeDerivativesMarketPairsListLatestCategory,
)
from ...models.get_v5_exchange_derivatives_market_pairs_list_latest_fee_type import (
    GetV5ExchangeDerivativesMarketPairsListLatestFeeType,
)
from ...models.get_v5_exchange_derivatives_market_pairs_list_latest_sort import (
    GetV5ExchangeDerivativesMarketPairsListLatestSort,
)
from ...models.get_v5_exchange_derivatives_market_pairs_list_latest_sort_dir import (
...
def _get_kwargs(
    *,
    ...
    start: int | Unset = 1,
    limit: int | Unset = 100,
    sort: GetV5ExchangeDerivativesMarketPairsListLatestSort | Unset = "volume_24h_strict",
    sort_dir: GetV5ExchangeDerivativesMarketPairsListLatestSortDir | Unset = "desc",
    category: GetV5ExchangeDerivativesMarketPairsListLatestCategory | Unset = "all",
    fee_type: GetV5ExchangeDerivativesMarketPairsListLatestFeeType | Unset = "all",
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DerivativesMarketPairsListLatestResponseModel.from_dict(response.json())
...
def sync_detailed(
    ...
    **Cache / Update frequency:** Every 60 seconds.
    ...
    Args:
        exchange_id (int | Unset):  Example: 270.
        exchange_slug (str | Unset):  Example: binance.
        start (int | Unset):  Default: 1.
        limit (int | Unset):  Default: 100.
        sort (GetV5ExchangeDerivativesMarketPairsListLatestSort | Unset):  Default:
            'volume_24h_strict'.
        sort_dir (GetV5ExchangeDerivativesMarketPairsListLatestSortDir | Unset):  Default: 'desc'.
        category (GetV5ExchangeDerivativesMarketPairsListLatestCategory | Unset):  Default: 'all'.
        fee_type (GetV5ExchangeDerivativesMarketPairsListLatestFeeType | Unset):  Default: 'all'.
    ...
    Returns:
        Response[DerivativesMarketPairsListLatestResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **Cache / Update frequency:** Every 60 seconds.
    ...
    Returns:
        DerivativesMarketPairsListLatestResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
