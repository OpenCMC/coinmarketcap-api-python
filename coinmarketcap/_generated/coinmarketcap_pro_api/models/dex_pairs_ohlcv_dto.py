...
T = TypeVar("T", bound="DexPairsOhlcvDTO")


@_attrs_define
class DexPairsOhlcvDTO:
    """
    Attributes:
        ...
        time_open (str | Unset): Timestamp (ISO 8601) of the start of this OHLCV period.
        time_close (str | Unset): Timestamp (ISO 8601) of the end of this OHLCV period. Always null as the current day
            is incomplete. See last_updated for the last UTC time included in the current OHLCV calculation.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dex_pairs_ohlcv_dto.additional_properties = d
        return dex_pairs_ohlcv_dto
