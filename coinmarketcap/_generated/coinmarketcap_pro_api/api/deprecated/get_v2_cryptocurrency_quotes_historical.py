...
from ...models.get_v2_cryptocurrency_quotes_historical_interval import (
...
def _get_kwargs(
    *,
    ...
    interval: GetV2CryptocurrencyQuotesHistoricalInterval | Unset = "5m",
...
def sync_detailed(
    ...
    **CMC equivalent pages:** Our historical cryptocurrency charts like [coinmarketcap.com/currencies/bi
    ...
    Args:
        ...
        interval (GetV2CryptocurrencyQuotesHistoricalInterval | Unset):  Default: '5m'.
        convert (str | Unset):
