...
T = TypeVar("T", bound="FCASListingsLatestCryptocurrencyObject")


@_attrs_define
class FCASListingsLatestCryptocurrencyObject:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fcas_listings_latest_cryptocurrency_object = cls(
            id=id,
            name=name,
            symbol=symbol,
            slug=slug,
        ...
        fcas_listings_latest_cryptocurrency_object.additional_properties = d
        return fcas_listings_latest_cryptocurrency_object
