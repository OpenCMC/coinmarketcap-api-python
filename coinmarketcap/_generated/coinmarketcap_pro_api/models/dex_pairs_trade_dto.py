...
if TYPE_CHECKING:
    from ..models.dex_transaction_dto import DexTransactionDTO
    from ..models.security_scan_result import SecurityScanResult


T = TypeVar("T", bound="DexPairsTradeDTO")


@_attrs_define
class DexPairsTradeDTO:
    """
    Attributes:
        trades (list[DexTransactionDTO] | Unset): A map of market quotes in different currency conversions. The default
            map included is USD.
    ...
    trades: list[DexTransactionDTO] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _trades is not UNSET:
            ...
            for trades_item_data in _trades:
                trades_item = DexTransactionDTO.from_dict(trades_item_data)
        ...
        dex_pairs_trade_dto.additional_properties = d
        return dex_pairs_trade_dto
