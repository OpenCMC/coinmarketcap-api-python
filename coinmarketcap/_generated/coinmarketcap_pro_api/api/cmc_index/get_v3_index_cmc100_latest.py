...
from ...models.api_response_of_index_latest_response_dto import ApiResponseOfIndexLatestResponseDTO
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ApiResponseOfIndexLatestResponseDTO.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    r"""CoinMarketCap 100 Index Latest
    ...
    api/v3/index/cmc100-latest`. See the [Keyless Public
    ...
    **CMC equivalent pages:** Our CoinMarketCap 100 Index on https://coinmarketcap.com/charts/cmc100/.
    ...
    Returns:
        Response[ApiResponseOfIndexLatestResponseDTO | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **CMC equivalent pages:** Our CoinMarketCap 100 Index on https://coinmarketcap.com/charts/cmc100/.
    ...
    Returns:
        ApiResponseOfIndexLatestResponseDTO | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
