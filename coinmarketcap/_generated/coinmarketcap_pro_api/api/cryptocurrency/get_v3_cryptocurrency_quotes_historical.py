...
from ...models.get_v3_cryptocurrency_quotes_historical_interval import (
...
def _get_kwargs(
    *,
    ...
    interval: GetV3CryptocurrencyQuotesHistoricalInterval | Unset = "5m",
...
def sync_detailed(
    ...
    **CMC equivalent pages:** Our historical cryptocurrency charts like [coinmarketcap.com/currencies/bi
    ...
    Args:
        ...
        interval (GetV3CryptocurrencyQuotesHistoricalInterval | Unset):  Default: '5m'.
        convert (str | Unset):
