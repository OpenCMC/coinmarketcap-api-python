...
if TYPE_CHECKING:
    from ..models.dex_quote_dto import DexQuoteDTO
    from ..models.security_scan_result import SecurityScanResult


T = TypeVar("T", bound="DexSpotPairDTO")


@_attrs_define
class DexSpotPairDTO:
    """
    Attributes:
        quote (list[DexQuoteDTO] | Unset): A map of market quotes in different currency conversions. The default map
            included is USD.
        ...
        scroll_id (str | Unset): A unique identifier used to fetch the next batch of results from the next API related
            API call, if applicable. scroll_id is an alternative to traditional pagingation techniques.
    """

    quote: list[DexQuoteDTO] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _quote is not UNSET:
            ...
            for quote_item_data in _quote:
                quote_item = DexQuoteDTO.from_dict(quote_item_data)
        ...
        dex_spot_pair_dto.additional_properties = d
        return dex_spot_pair_dto
