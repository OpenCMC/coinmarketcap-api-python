...
T = TypeVar("T", bound="DexParisQuotesDTO")


@_attrs_define
class DexParisQuotesDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dex_paris_quotes_dto.additional_properties = d
        return dex_paris_quotes_dto
