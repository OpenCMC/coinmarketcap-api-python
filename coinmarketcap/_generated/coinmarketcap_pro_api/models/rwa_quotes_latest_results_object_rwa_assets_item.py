...
from ..models.rwa_quotes_latest_results_object_rwa_assets_item_asset_type import (
    RWAQuotesLatestResultsObjectRwaAssetsItemAssetType,
    check_rwa_quotes_latest_results_object_rwa_assets_item_asset_type,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.rwa_quotes_latest_results_object_rwa_assets_item_quotes_item import (
        RWAQuotesLatestResultsObjectRwaAssetsItemQuotesItem,
    )
    from ..models.rwa_quotes_latest_results_object_rwa_assets_item_tokens_item import (
        RWAQuotesLatestResultsObjectRwaAssetsItemTokensItem,
    )
    from ..models.rwa_quotes_latest_results_object_rwa_assets_item_tradfi_markets_item import (
        RWAQuotesLatestResultsObjectRwaAssetsItemTradfiMarketsItem,
    )


T = TypeVar("T", bound="RWAQuotesLatestResultsObjectRwaAssetsItem")


@_attrs_define
class RWAQuotesLatestResultsObjectRwaAssetsItem:
    """
    Attributes:
        ...
        asset_type (RWAQuotesLatestResultsObjectRwaAssetsItemAssetType | Unset): Asset type. One of `stock`,
            `commodity`, `currency`, `government_security`, `etf`, `real_estate`. Example: stock.
        ...
        tokens (list[RWAQuotesLatestResultsObjectRwaAssetsItemTokensItem] | Unset): Underlying on-chain tokens
            representing this asset. May be empty when the asset has no tokenized representation.
        tradfi_markets (list[RWAQuotesLatestResultsObjectRwaAssetsItemTradfiMarketsItem] | Unset): Crypto exchanges
            where the tokenized asset trades. May be empty if no tracked market exists for this asset.
        quotes (list[RWAQuotesLatestResultsObjectRwaAssetsItemQuotesItem] | Unset): Convertible tokenized values; one
    ...
    asset_type: RWAQuotesLatestResultsObjectRwaAssetsItemAssetType | Unset = UNSET
    ...
    tokens: list[RWAQuotesLatestResultsObjectRwaAssetsItemTokensItem] | Unset = UNSET
    tradfi_markets: list[RWAQuotesLatestResultsObjectRwaAssetsItemTradfiMarketsItem] | Unset = UNSET
    quotes: list[RWAQuotesLatestResultsObjectRwaAssetsItemQuotesItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        tradfi_markets: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.tradfi_markets, Unset):
            tradfi_markets = []
            for tradfi_markets_item_data in self.tradfi_markets:
                tradfi_markets_item = tradfi_markets_item_data.to_dict()
                tradfi_markets.append(tradfi_markets_item)
        ...
        if tradfi_markets is not UNSET:
            field_dict["tradfi_markets"] = tradfi_markets
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_type: RWAQuotesLatestResultsObjectRwaAssetsItemAssetType | Unset
        if isinstance(_asset_type, Unset):
            asset_type = UNSET
        else:
            asset_type = check_rwa_quotes_latest_results_object_rwa_assets_item_asset_type(_asset_type)
        ...
        if _tokens is not UNSET:
            ...
            for tokens_item_data in _tokens:
                tokens_item = RWAQuotesLatestResultsObjectRwaAssetsItemTokensItem.from_dict(tokens_item_data)

                tokens.append(tokens_item)

        _tradfi_markets = d.pop("tradfi_markets", UNSET)
        tradfi_markets: list[RWAQuotesLatestResultsObjectRwaAssetsItemTradfiMarketsItem] | Unset = UNSET
        if _tradfi_markets is not UNSET:
            tradfi_markets = []
            for tradfi_markets_item_data in _tradfi_markets:
                tradfi_markets_item = RWAQuotesLatestResultsObjectRwaAssetsItemTradfiMarketsItem.from_dict(
                    tradfi_markets_item_data
                )
        ...
        if _quotes is not UNSET:
            ...
            for quotes_item_data in _quotes:
                quotes_item = RWAQuotesLatestResultsObjectRwaAssetsItemQuotesItem.from_dict(quotes_item_data)

                quotes.append(quotes_item)

        rwa_quotes_latest_results_object_rwa_assets_item = cls(
            rwa_id=rwa_id,
            name=name,
            symbol=symbol,
            slug=slug,
        ...
        rwa_quotes_latest_results_object_rwa_assets_item.additional_properties = d
        return rwa_quotes_latest_results_object_rwa_assets_item
