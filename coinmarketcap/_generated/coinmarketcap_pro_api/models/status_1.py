...
class Status1:
    ...
    Attributes:
        ...
        error_code (int): An internal error code for the current error. If a unique platform error code is not available
            the HTTP status code is returned. Default: 401. Example: 1002.
        error_message (str): An error message to go along with the error code. Example: API key missing..
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status_1.additional_properties = d
        return status_1
