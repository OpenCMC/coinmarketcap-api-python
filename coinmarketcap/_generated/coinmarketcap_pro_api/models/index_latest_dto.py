...
T = TypeVar("T", bound="IndexLatestDTO")


@_attrs_define
class IndexLatestDTO:
    ...
    Attributes:
        ...
        value (float | Unset): Current value of CoinMarketCap 100 Index.
        value_24h_percentage_change (float | Unset): Percentage change of the CoinMarketCap 100 Index over the past 24h.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        index_latest_dto.additional_properties = d
        return index_latest_dto
