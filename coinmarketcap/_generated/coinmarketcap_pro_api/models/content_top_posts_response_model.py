...
T = TypeVar("T", bound="ContentTopPostsResponseModel")


@_attrs_define
class ContentTopPostsResponseModel:
    """
    Example:
        {'data': {'list': [{'post_id': '123456789', 'comments_url':
            ...
            'ethereum'}], 'repost_count': '0', 'language_code': 'en'}], 'last_score': '38507.8865'}, 'status': {'timestamp':
            '2022-09-08T16:08:52.641Z', 'error_code': 0, 'error_message': 'SUCCESS', 'elapsed': 0, 'credit_count': 0}}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        content_top_posts_response_model = cls(
            data=data,
            status=status,
        )

        content_top_posts_response_model.additional_properties = d
        return content_top_posts_response_model
