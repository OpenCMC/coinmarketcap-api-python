...
from ...models.api_response_of_cmc20_index_historical_response_dto import ApiResponseOfCMC20IndexHistoricalResponseDTO
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ApiResponseOfCMC20IndexHistoricalResponseDTO.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    r"""CoinMarketCap 20 Index Historical
    ...
    api/v3/index/cmc20-historical`. See the [Keyless Public
    ...
    **CMC equivalent pages:** Our CoinMarketCap 20 Index on https://coinmarketcap.com/charts/cmc20/.
    ...
    Returns:
        Response[ApiResponseOfCMC20IndexHistoricalResponseDTO | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **CMC equivalent pages:** Our CoinMarketCap 20 Index on https://coinmarketcap.com/charts/cmc20/.
    ...
    Returns:
        ApiResponseOfCMC20IndexHistoricalResponseDTO | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
