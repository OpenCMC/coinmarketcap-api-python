...
T = TypeVar("T", bound="CMC20IndexHistoricalDTO")


@_attrs_define
class CMC20IndexHistoricalDTO:
    """
    Attributes:
        ...
        value (float | Unset): Value of CoinMarketCap 20 Index.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cmc20_index_historical_dto = cls(
            constituents=constituents,
            update_time=update_time,
            value=value,
        )

        cmc20_index_historical_dto.additional_properties = d
        return cmc20_index_historical_dto
