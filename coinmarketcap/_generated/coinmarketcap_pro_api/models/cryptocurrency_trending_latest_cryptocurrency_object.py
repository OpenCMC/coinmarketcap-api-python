...
T = TypeVar("T", bound="CryptocurrencyTrendingLatestCryptocurrencyObject")


@_attrs_define
class CryptocurrencyTrendingLatestCryptocurrencyObject:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cryptocurrency_trending_latest_cryptocurrency_object = cls(
            id=id,
            name=name,
            symbol=symbol,
            slug=slug,
        ...
        cryptocurrency_trending_latest_cryptocurrency_object.additional_properties = d
        return cryptocurrency_trending_latest_cryptocurrency_object
