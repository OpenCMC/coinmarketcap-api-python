...
class Status:
    ...
    Attributes:
        ...
        error_code (int): An internal error code for the current error. If a unique platform error code is not available
            the HTTP status code is returned. Default: 400. Example: 400.
        error_message (str): An error message to go along with the error code. Example: Invalid value for \"id\".
