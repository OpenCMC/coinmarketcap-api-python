...
class RWAQuotesLatestResultsObject:
    ...
    Example:
        {'rwa_assets': [{'name': 'NVIDIA', 'symbol': 'NVDA', 'slug': 'nvidia', 'quotes': [{'symbol': 'USD', 'crypto_id':
            2781, 'average_tokenized_price': 211.04769840665475, 'tokenized_market_cap': 3726091.2870977107,
