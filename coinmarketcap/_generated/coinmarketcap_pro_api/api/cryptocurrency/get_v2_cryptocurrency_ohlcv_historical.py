...
from ...models.get_v2_cryptocurrency_ohlcv_historical_interval import (
    GetV2CryptocurrencyOhlcvHistoricalInterval,
)
from ...models.get_v2_cryptocurrency_ohlcv_historical_time_period import (
...
def _get_kwargs(
    *,
    ...
    time_period: GetV2CryptocurrencyOhlcvHistoricalTimePeriod | Unset = "daily",
    time_start: str | Unset = UNSET,
    time_end: str | Unset = UNSET,
    count: float | Unset = 10.0,
    interval: GetV2CryptocurrencyOhlcvHistoricalInterval | Unset = "daily",
...
def sync_detailed(
    ...
    **CMC equivalent pages:** Our historical cryptocurrency data pages like
    ...
    Args:
        ...
        slug (str | Unset):
        symbol (str | Unset):
        time_period (GetV2CryptocurrencyOhlcvHistoricalTimePeriod | Unset):  Default: 'daily'.
        time_start (str | Unset):
        time_end (str | Unset):
        count (float | Unset):  Default: 10.0.
        interval (GetV2CryptocurrencyOhlcvHistoricalInterval | Unset):  Default: 'daily'.
        convert (str | Unset):
