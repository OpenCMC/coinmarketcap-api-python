...
T = TypeVar("T", bound="LiquidationsTotalResultsObjectQuotesItem")


@_attrs_define
class LiquidationsTotalResultsObjectQuotesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        liquidations_total_results_object_quotes_item = cls(
            crypto_id=crypto_id,
            symbol=symbol,
        ...
        liquidations_total_results_object_quotes_item.additional_properties = d
        return liquidations_total_results_object_quotes_item
