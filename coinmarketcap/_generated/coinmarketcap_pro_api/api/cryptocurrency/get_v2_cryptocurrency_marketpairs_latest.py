...
from ...models.get_v2_cryptocurrency_marketpairs_latest_category import (
    GetV2CryptocurrencyMarketpairsLatestCategory,
)
from ...models.get_v2_cryptocurrency_marketpairs_latest_fee_type import (
    GetV2CryptocurrencyMarketpairsLatestFeeType,
)
from ...models.get_v2_cryptocurrency_marketpairs_latest_sort import (
    GetV2CryptocurrencyMarketpairsLatestSort,
)
from ...models.get_v2_cryptocurrency_marketpairs_latest_sort_dir import (
...
def _get_kwargs(
    *,
    ...
    start: int | Unset = 1,
    limit: int | Unset = 100,
    sort_dir: GetV2CryptocurrencyMarketpairsLatestSortDir | Unset = "desc",
    sort: GetV2CryptocurrencyMarketpairsLatestSort | Unset = "volume_24h_strict",
    aux: str | Unset = "num_market_pairs,category,fee_type",
    matched_id: str | Unset = UNSET,
    matched_symbol: str | Unset = UNSET,
    category: GetV2CryptocurrencyMarketpairsLatestCategory | Unset = "all",
    fee_type: GetV2CryptocurrencyMarketpairsLatestFeeType | Unset = "all",
...
def sync_detailed(
    ...
    **CMC equivalent pages:** Our active cryptocurrency markets pages like [coinmarketcap.com/currencies
    ...
    Args:
        ...
        sort_dir (GetV2CryptocurrencyMarketpairsLatestSortDir | Unset):  Default: 'desc'.
        sort (GetV2CryptocurrencyMarketpairsLatestSort | Unset):  Default: 'volume_24h_strict'.
        aux (str | Unset):  Default: 'num_market_pairs,category,fee_type'.
        matched_id (str | Unset):
        matched_symbol (str | Unset):
        category (GetV2CryptocurrencyMarketpairsLatestCategory | Unset):  Default: 'all'.
        fee_type (GetV2CryptocurrencyMarketpairsLatestFeeType | Unset):  Default: 'all'.
        convert (str | Unset):
