...
if TYPE_CHECKING:
    from ..models.cryptocurrency_listings_latest_quote_map_2 import CryptocurrencyListingsLatestQuoteMap2
    from ..models.platform_type_0 import PlatformType0


T = TypeVar("T", bound="CryptocurrencyListingsLatestCryptocurrencyObject2")


@_attrs_define
class CryptocurrencyListingsLatestCryptocurrencyObject2:
    ...
    Attributes:
        ...
        quote (CryptocurrencyListingsLatestQuoteMap2): A map of market quotes in different currency conversions. The
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quote = CryptocurrencyListingsLatestQuoteMap2.from_dict(d.pop("quote"))
        ...
        cryptocurrency_listings_latest_cryptocurrency_object_2 = cls(
            id=id,
            name=name,
            symbol=symbol,
            slug=slug,
        ...
        cryptocurrency_listings_latest_cryptocurrency_object_2.additional_properties = d
        return cryptocurrency_listings_latest_cryptocurrency_object_2
