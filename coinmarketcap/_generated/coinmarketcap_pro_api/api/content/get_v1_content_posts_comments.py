...
from ...models.content_post_comments_response_model import ContentPostCommentsResponseModel
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ContentPostCommentsResponseModel.from_dict(response.json())
...
def sync_detailed(
    ...
    **Plan credit use:** 0 credit
    ...
    Returns:
        Response[ContentPostCommentsResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **Plan credit use:** 0 credit
    ...
    Returns:
        ContentPostCommentsResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
