...
T = TypeVar("T", bound="AirdropAirdropObject")


@_attrs_define
class AirdropAirdropObject:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        airdrop_airdrop_object.additional_properties = d
        return airdrop_airdrop_object
