...
T = TypeVar("T", bound="CryptocurrencyTrendingGainersLosersResponseModel")


@_attrs_define
class CryptocurrencyTrendingGainersLosersResponseModel:
    """
    Example:
    ...
    def to_dict(self) -> dict[str, Any]:
        data = []
        for componentsschemas_cryptocurrency_trending_gainers_losers_results_array_item_data in self.data:
            componentsschemas_cryptocurrency_trending_gainers_losers_results_array_item = (
                componentsschemas_cryptocurrency_trending_gainers_losers_results_array_item_data.to_dict()
            )
            data.append(componentsschemas_cryptocurrency_trending_gainers_losers_results_array_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data = []
        _data = d.pop("data")
        for componentsschemas_cryptocurrency_trending_gainers_losers_results_array_item_data in _data:
            componentsschemas_cryptocurrency_trending_gainers_losers_results_array_item = (
                CryptocurrencyCryptocurrencyObject.from_dict(
                    componentsschemas_cryptocurrency_trending_gainers_losers_results_array_item_data
                )
            )
        ...
        cryptocurrency_trending_gainers_losers_response_model = cls(
            data=data,
            status=status,
        )

        cryptocurrency_trending_gainers_losers_response_model.additional_properties = d
        return cryptocurrency_trending_gainers_losers_response_model
