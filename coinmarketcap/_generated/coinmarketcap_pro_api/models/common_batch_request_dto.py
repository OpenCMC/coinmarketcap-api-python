...
T = TypeVar("T", bound="CommonBatchRequestDTO")


@_attrs_define
class CommonBatchRequestDTO:
    """
    Attributes:
        crypto_id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_batch_request_dto = cls(
            crypto_id=crypto_id,
            scores=scores,
        )

        common_batch_request_dto.additional_properties = d
        return common_batch_request_dto
