...
T = TypeVar("T", bound="DqueryHoldersRequestDTO")


@_attrs_define
class DqueryHoldersRequestDTO:
    """holders request
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dquery_holders_request_dto = cls(
            token_address=token_address,
            platform=platform,
            tag=tag,
        )

        dquery_holders_request_dto.additional_properties = d
        return dquery_holders_request_dto
