...
T = TypeVar("T", bound="CryptoListingDTO")


@_attrs_define
class CryptoListingDTO:
    """
    Attributes:
        id (int | Unset):
        name (str | Unset):
        ...
        self_reported_circulating_supply (float | None | Unset): Self-reported circulating supply
        self_reported_market_cap (float | None | Unset): Self-reported market capitalization
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        crypto_listing_dto.additional_properties = d
        return crypto_listing_dto
