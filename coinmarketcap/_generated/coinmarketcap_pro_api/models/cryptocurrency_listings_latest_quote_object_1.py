...
T = TypeVar("T", bound="CryptocurrencyListingsLatestQuoteObject1")


@_attrs_define
class CryptocurrencyListingsLatestQuoteObject1:
    """A market quote in the currency conversion option.

    Attributes:
        price (float): Price in the specified currency for this historical. Example: 7139.82.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cryptocurrency_listings_latest_quote_object_1 = cls(
            price=price,
            volume_24h=volume_24h,
            market_cap=market_cap,
            market_cap_dominance=market_cap_dominance,
        ...
        cryptocurrency_listings_latest_quote_object_1.additional_properties = d
        return cryptocurrency_listings_latest_quote_object_1
