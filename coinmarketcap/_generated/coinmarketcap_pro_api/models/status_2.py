...
class Status2:
    ...
    Attributes:
        ...
        error_code (int): An internal error code for the current error. If a unique platform error code is not available
            the HTTP status code is returned. Default: 403. Example: 1006.
        error_message (str): An error message to go along with the error code. Example: Your API Key subscription plan
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status_2.additional_properties = d
        return status_2
