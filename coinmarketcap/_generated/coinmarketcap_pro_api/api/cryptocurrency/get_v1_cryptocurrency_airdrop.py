...
from ...models.airdrop_response_model import AirdropResponseModel
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AirdropResponseModel.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Airdrop
     ...
     Returns information about a single airdrop available on CoinMarketCap. Includes the cryptocurrency
    metadata.
    ...
    **CMC equivalent pages:** Our free airdrops page
    ...
    Returns:
        Response[AirdropResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject]
    """
...
def sync(
    ...
    **CMC equivalent pages:** Our free airdrops page
    ...
    Returns:
        AirdropResponseModel | HTTPStatus400ErrorObject | HTTPStatus401ErrorObject | HTTPStatus403ErrorObject | HTTPStatus429ErrorObject | HTTPStatus500ErrorObject
    """
